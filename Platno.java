...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Brick Breaker 2D", 860, 500, 
                Color.white);
        }
    ...
    private Platno(String titulok, int sirka, int vyska, Color pozadie) {
        ...
        //Moznost zatvorenia programu pomocu krizika - 6.12.2022
